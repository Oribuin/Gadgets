package dev.oribuin.gadgets.database.connector;
...
public class SQLiteConnector implements DatabaseConnector {
    ...
    public SQLiteConnector(GadgetsPlugin javaPlugin) {
        this(javaPlugin, GadgetsPlugin.get().getName().toLowerCase());
    }

    public SQLiteConnector(GadgetsPlugin javaPlugin, String dbName) {
