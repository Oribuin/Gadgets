package dev.oribuin.gadgets.scheduler;

import dev.oribuin.gadgets.GadgetsPlugin;
import dev.oribuin.gadgets.scheduler.task.ScheduledTask;
import dev.oribuin.gadgets.scheduler.wrapper.BukkitSchedulerWrapper;
import dev.oribuin.gadgets.scheduler.wrapper.FoliaSchedulerWrapper;
import dev.oribuin.gadgets.scheduler.wrapper.SchedulerWrapper;
import dev.oribuin.gadgets.util.NMSUtil;
...
public class PluginScheduler implements SchedulerWrapper {
    ...
    private PluginScheduler(GadgetsPlugin javaPlugin) {
        if (instance != null)
    ...
    public static PluginScheduler get() {
        if (instance == null) {
            instance = new PluginScheduler(GadgetsPlugin.get());
        }
        return instance;
    }
