...
public class UpgradedExplosiveTool extends ExplosiveItem {

    public UpgradedExplosiveTool() {
        super("upgraded_explosive_tool");

        this.items.put("upgraded_explosive_pickaxe", ItemConstruct.of(Material.DIAMOND_PICKAXE)
                .setName("<#93bc80><bold>Explosive Pickaxe")
                .setLore("",
                        " <white>| <gray>Destroys nearby blocks within a 3x3 radius"
                ));

        this.items.put("upgraded_explosive_shovel", ItemConstruct.of(Material.DIAMOND_SHOVEL)
                .setName("<#93bc80><bold>Explosive Pickaxe")
                .setLore("",
                        " <white>| <gray>Destroys nearby blocks within a 3x3 radius"
                ));
